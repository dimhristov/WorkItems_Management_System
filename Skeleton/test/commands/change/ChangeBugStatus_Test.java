...
public class ChangeBugStatus_Test {
    ...
    public void before() {
        ...
        command = new ChangeBugStatus(repository);
    ...
    @Test
    public void changeBugStatus_should_changeTheStatusOfBug() {
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add("Steven");
        ...
        // Assert
        Assertions.assertEquals(repository.findBoard("BoardName","Alpha").findBug("BugTitleName").getBugType().toString(),"Fixed");
    }
}
