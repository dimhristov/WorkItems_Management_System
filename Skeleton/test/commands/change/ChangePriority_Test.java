...
import com.wim.commands.change.ChangeBugStatus;
import com.wim.commands.change.ChangePriority;
...
public class ChangePriority_Test {
    ...
    @Test
    public void changePriority_should_changePriorityOfItem() {
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add("Steven");
        ...
        // Assert
        Assertions.assertEquals(repository.findBoard("BoardName","Alpha").findBug("BugTitleName").getPriorityType().toString(),"Medium");
    }
}
