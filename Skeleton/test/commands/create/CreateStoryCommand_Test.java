...
public class CreateStoryCommand_Test {
    ...
    public void before() {
        ...
        command = new CreateStoryCommand(factory, repository);
    ...
    @Test
    public void execute_should_createStory_when_boardExist() {
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add("StoryTitleName");
